...
- **Lazy Propagation**: Not updating the content until necessary, mostly used in segment trees. It reduces the unnecessary computations. It enables updates in logarithmic time.
